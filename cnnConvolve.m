...
%convolved4D convovlve input image
%
% Parameters:
%  images - images to be convolved
%  W - convolutional kernel
%  b - convolved features to pool (as given by cnnConvolve)
%                      convolvedFeatures(imageRow, imageCol, featureNum, imageNum)
%
% Returns:
%  convovledFeatures - convolved features to pool (as given by cnnPool or orginal image)
%                      convolvedFeatures(imageRow, imageCol, featureNum, imageNum)
%
    filterDim = size(W,1);
